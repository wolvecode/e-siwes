                            ...
                            @forelse($organizations as $organization)
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                           <div class="d-flex m">
                                               <a class="btn btn-success bd bd-0" href="{{ route('displayImage',$organization->placement_attachment) }}" target="_blank">
                                                   <i class="far fa-file-alt"></i>
                                               </a>
                                               <form action="{{ route('verifyOrganization', $organization->id) }}" method="post">
                                                   @csrf
