                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $organizations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $organization): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                           <div class="d-flex m">
                                               <a class="btn btn-success bd bd-0" href="<?php echo e(route('displayImage',$organization->placement_attachment)); ?>" target="_blank">
                                                   <i class="far fa-file-alt"></i>
                                               </a>
                                               <form action="<?php echo e(route('verifyOrganization', $organization->id)); ?>" method="post">
                                                   <?php echo csrf_field(); ?>
                                                   <button class="btn-primary px-3 rounded-5 bd-0 br-1 py-2 ml-2">
                                                       <i class="far fa-check-circle"></i>
                                                   </button>
                                               </form>
                                               <form action="<?php echo e(route('deleteOrganization', $organization->id)); ?>" method="post">
                                                   <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wolvecode/projects/e-siwes/resources/views/admin/org-request-list.blade.php ENDPATH**/ ?>