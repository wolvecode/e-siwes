                                            ...
                                            <div>
                                                <div class="d-flex m">
                                                    <a class="btn btn-success rounded-5 bd bd-0 br-1 py-2 px-3 mr-2"
                                                        href="<?php echo e(route('displayImage', $acceptance->attachment)); ?>"
                                                        target="_blank">
                                                        <i class="far fa-file-alt"></i>
                                                    </a>
                                                    <form action="<?php echo e(route('verifyAcceptance', $acceptance->id)); ?>"
                                                        method="post">
                                                        <?php echo csrf_field(); ?>
                                                    ...
                                                    <form action="<?php echo e(route('declineAcceptance', $acceptance->id)); ?>"
                                                        method="post">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/techbigo1/Desktop/workspace/e-siwes/resources/views/new-acceptance.blade.php ENDPATH**/ ?>