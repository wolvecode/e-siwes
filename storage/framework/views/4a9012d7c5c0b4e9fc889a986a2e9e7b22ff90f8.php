...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        <?php if(auth()->guard('user')->check()): ?>
            <p class="">  <?php echo e(auth('user')->user()->name); ?> </p>
            
        <?php endif; ?>
        <?php if(auth()->guard('student')->check()): ?>
            <?php if (isset($component)) { $__componentOriginal9574114c0ff9474f4ea56027a3d701b86d019da3 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Username::class, []); ?>
...
<?php /**PATH /Users/techbigo1/Desktop/workspace/e-siwes/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>