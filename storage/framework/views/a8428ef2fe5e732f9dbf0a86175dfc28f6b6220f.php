                ...
                <div class="d-flex flex-row ">
                    <div class="card  box-shadow-0">
                        ...
                        <div class="card-header">
                            ...
                            <p class="mb-2">Generate login for Admin (email and password for login)</p>
                        </div>
                        <div class="card-body pt-0">
                            <form action="<?php echo e(route('addAdmin')); ?>" method="post" class="form-horizontal" >
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wolvecode/projects/e-siwes/resources/views/admin/addAdmin.blade.php ENDPATH**/ ?>